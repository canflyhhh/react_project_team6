        ...
        if (doc.id == Id) {
          ...
          if (doc.data().photo) {
            try {
              ...
              data.push({ time: doc.data().datetime, account: doc.data().account, context: doc.data().context, title: doc.data().title, photo: photoURL, tag: doc.data().tag  });
            } catch (error) {
              console.error("Error fetching photo URL:", error);
            }
          } else {
            data.push({ time: doc.data().datetime, account: doc.data().account, context: doc.data().context, title: doc.data().title, photo: null, tag: doc.data().tag });
          }
        }
      });
